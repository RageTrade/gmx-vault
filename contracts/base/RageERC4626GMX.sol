...
abstract contract RageERC4626GMX is ERC4626Upgradeable {
    ...
    function withdraw(
        ...
        //Cant transfer asset (Staked GLP)
    ...
    function withdrawTokens(address to, uint256 amount) internal virtual;
}
